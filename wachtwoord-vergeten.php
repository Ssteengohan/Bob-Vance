...
navbar();
	$connect = new PDO("mysql:host=localhost;dbname=bob", "root", "");
    ...
    if (isset($_POST['Vergeten'])) {
        ...
        if ($row1['num'] > 0 || $row['num'] > 0)
        {
                ...
                Klik op wachtwoord vergeten om je wachtwoord te resetten: <a href=http://localhost/bob/wachtwoord-vergeten.php?email=' . $email . '>Wachtwoord vergeten?</a>';
